...
export const PLAYGROUND_CODEX_IMAGE_UPLOADING_SESSION_ID = "playground-codex-image-uploading-feed";
export const PLAYGROUND_CODEX_IMAGE_PROCESSING_SESSION_ID = "playground-codex-image-processing-feed";
export const PLAYGROUND_CODEX_IMAGE_RESPONDING_SESSION_ID = "playground-codex-image-responding-feed";
